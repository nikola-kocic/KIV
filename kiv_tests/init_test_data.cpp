...
void InitTestData::createFiles(const QList<ArchiveFileInfo> &folders
...
{
    const QList<ArchiveFileInfo> folders = dsf.getDirs();
    const QList<ArchiveFileInfo> files = dsf.getFiles();
